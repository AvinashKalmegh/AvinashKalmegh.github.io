    ...
    color={colorMode==="dark"? "white" : "#13022C"} p="30px 0px">
      ...
      <Box w={["80%", "80%", "60%"]} m="auto">
        <Link href="https://github.com/AvinashKalmegh">
          ...
          : "https://github-readme-streak-stats.herokuapp.com?user=AvinashKalmegh&theme=material-palenight&date_format=M%20j%5B%2C%20Y%5D"}
          />
        </Link>
      </Box>
      ...
      <Box w={["80%", "70%", "60%"]} display= "flex" m="auto" mt={["", "10px", "0px"]} gap="10px">
        <Link href="https://github.com/AvinashKalmegh">  
          <Image
            ...
            "https://github-readme-stats.vercel.app/api/top-langs/?username=AvinashKalmegh&theme=material-palenight"}  //launguages
          />
        </Link>
        <Link href="https://github.com/AvinashKalmegh">
          <Image
            ...
            :"https://github-readme-stats.vercel.app/api?username=AvinashKalmegh&count_private=true&show_icons=true&theme=material-palenight"} //stats
          />
        </Link>
      </Box>
    </Box>
