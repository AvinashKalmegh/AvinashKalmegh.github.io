        ...
        >
          ...
          >
            ...
            <Text fontFamily="calibri" mt="10px" fontSize={["md", "lg", "xl"]}>
              ...
              Developer with proficiency in JavaScript and React.
              Problem-solving mindset and ability to perform well in
              collaboration. 1200+ hours of coding. Looking forward to work as
              an accountable and competent employee in a tech company.
            </Text>
          </Box>
        ...
        >
          <Box>
            <Box
              ...
              bg="url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbpISbEAgaxcUr-mYQDRlSq_91HzaBWMECMQ&usqp=CAU)"
            >
              <Box
                ...
                rounded="50%"
                bg="url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsvtJvtIPahIGUcO6pJaei-I41Wi7fScoXrA&usqp=CAU)"
              >
                <Text
                  color="#13022c"
                  fontWeight="bold"
...
// {colorMode==="dark"? "linear-gradient(180deg, rgba(44,23,75,1) 45%, rgba(28,14,50,1) 99%)" : "#bdb6c9"}
